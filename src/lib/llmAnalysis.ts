    ...
    messages: [
      {
        ...
        content: [
          ...
          '避免绝对预言、读心，以及替用户作出医疗、法律、投资、生死决定。',
          '遇到高风险内容时，保留具体对象，并改写为风险信号、影响因素、个人判断或可控行动层面的提问，不能把具体对象删除。',
          '例如用户问“一周内的黄金价格走势如何”，应改写为“面对一周内黄金价格的可能波动，我需要关注哪些风险信号和决策因素？”，不能改成“我的整体运势如何？”。',
